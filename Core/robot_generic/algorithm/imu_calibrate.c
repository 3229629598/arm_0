...
imu_data_fp_t imu_correct(imu_data_raw_t* imu_d, imu_acc_cal_t* acc_cali, imu_gyro_cal_t* gyro_cali){
	imu_data_fp_t imu_corr;
	imu_corr.ax = (acc_cali->accel_T[0][0]*imu_d->ax + acc_cali->accel_T[0][1]*imu_d->ay + acc_cali->accel_T[0][2]*imu_d->az - acc_cali->accel_offs[0]);
	imu_corr.ay = (acc_cali->accel_T[1][0]*imu_d->ax + acc_cali->accel_T[1][1]*imu_d->ay + acc_cali->accel_T[1][2]*imu_d->az - acc_cali->accel_offs[1]);
	imu_corr.az = (acc_cali->accel_T[2][0]*imu_d->ax + acc_cali->accel_T[2][1]*imu_d->ay + acc_cali->accel_T[2][2]*imu_d->az - acc_cali->accel_offs[2]);
	...
	if(gyro_cali != 0){
		imu_corr.gx = ((float)imu_d->gx - gyro_cali->gx_bias)*(imu_d->g_fullscale/(float)(IMU_RAW_RANGE));
		imu_corr.gy = ((float)imu_d->gy - gyro_cali->gy_bias)*(imu_d->g_fullscale/(float)(IMU_RAW_RANGE));
		imu_corr.gz = ((float)imu_d->gz - gyro_cali->gz_bias)*(imu_d->g_fullscale/(float)(IMU_RAW_RANGE));
	}
